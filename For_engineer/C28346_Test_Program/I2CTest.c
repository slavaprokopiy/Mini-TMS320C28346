...
void I2CMemoryTest(void){
	...
	void I2CA_Init(void)
	{
	   ...
	   #if (CPU_FRQ_300MHZ)             // For 300MHz SYSCLKOUT
	        I2caRegs.I2CPSC.all = 29;   // Prescaler - need 7-12 Mhz on module clk (300/30 = 10MHz)
	   #endif
	   #if (CPU_FRQ_250MHZ)             // For 250MHz SYSCLKOUT
	       I2caRegs.I2CPSC.all = 24;    // Prescaler - need 7-12 Mhz on module clk (250/25 = 10MHz)
	   #endif
	...
	void fail()
	{
		msg = "ERROR:I2C Memory test failed!\r===========================\r\0";
		scia_msg(msg);
		I2CTestComplete = 1;
	}
